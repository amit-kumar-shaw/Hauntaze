...
class Tile(pygame.sprite.Sprite):
    def __init__(self, pos, groups, level, wall, storymode=False):
        ...
        if wall:
            ...
            floor1 = pygame.image.load(f"./assets/images/tiles/floor_1.png").convert_alpha()
            floor2 = pygame.image.load(f"./assets/images/tiles/floor_2.png").convert_alpha()
            floor3 = pygame.image.load(f"./assets/images/tiles/floor_3.png").convert_alpha()
            floor4 = pygame.image.load(f"./assets/images/tiles/floor_4.png").convert_alpha()
