...
class UI:
    ...
    def __init__(self, player1, player2, level):
        ...
        coin = pygame.image.load("./assets/images/ui/coin.png").convert_alpha()
        heart = pygame.image.load("./assets/images/ui/heart.png").convert_alpha()
        ...
        if player1:
            ...
            player = pygame.image.load("./assets/images/player/p1/idle/PlayerIdle1.png").convert_alpha()
            player_rect = player.get_rect(midleft=(-3, 8))
            self.p1_surf.blit(player, player_rect)
        ...
        if player2:
            ...
            player = pygame.image.load("./assets/images/player/p2/idle/PlayerIdle1.png").convert_alpha()
            player = pygame.transform.flip(player, True, False)
            player_rect = player.get_rect(midright=(103, 8))
            self.p2_surf.blit(player, player_rect)
    ...
    def update_level(self):
        """ update level or hint when new level starts"""
